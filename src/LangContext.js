  ...
  fr: {
    ...
    how: {
      ...
      steps: [
        ...
        { num: '02', title: 'Commandez', desc: 'Choisissez votre pièce, réglez en un instant via Stripe. Votre boutique est notifiée immédiatement.' },
    ...
    boutiques: {
      ...
      stats: [
        { value: '20+', label: 'Boutiques partenaires Day 1' },
  ...
  en: {
    ...
    how: {
      ...
      steps: [
        ...
        { num: '02', title: 'Order', desc: 'Choose your piece, pay instantly via Stripe. Your boutique is notified immediately.' },
    ...
    boutiques: {
      ...
      stats: [
        { value: '20+', label: 'Partner boutiques Day 1' },
