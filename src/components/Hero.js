  ...
  return (
    <section style={{
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '580px' }}>
        ...
        <motion.div {...fadeUp(0.8)} style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <button
      ...
      >
        ...
        <motion.div
          ...
          style={{ width: '1px', height: '40px', background: 'linear-gradient(#C9A96E, transparent)' }}
        />
      </motion.div>
    </section>
  );
